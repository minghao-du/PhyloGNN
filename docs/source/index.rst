...
.. container:: hero
   ...
   .. container:: hero-actions
      ...
      :doc:`Start with the quickstart <quickstart>`
      :doc:`Install the package <installation>`

Fastest path
------------

.. container:: entry-grid
   ...
   .. container:: entry-card
      ...
      **Reference**
      ...
      Look up curated public APIs for data conversion, models, training, I/O,
      and utilities.
...
.. container:: workflow-strip
   ...
   **Typical workflow:** tree input → feature engineering → graph conversion →
   training → metrics tracking when needed → API lookup for implementation
   details.
